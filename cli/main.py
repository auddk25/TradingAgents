...
def save_report_to_disk(final_state, ticker: str, save_path: Path):
    ...
    if analyst_parts:
        ...
        sections.append(f"## I. Analyst Summaries\n\n{content}")
    ...
    if final_state.get("trader_investment_plan"):
        ...
        sections.append(f"## III. Trading View\n\n### Trader\n{final_state['trader_investment_plan']}")
...
def display_complete_report(final_state):
    ...
    if analysts:
        console.print(Panel("[bold]I. Analyst Summaries[/bold]", border_style="cyan"))
    ...
    # III. Trading View
    if final_state.get("trader_investment_plan"):
        console.print(Panel("[bold]III. Trading View[/bold]", border_style="yellow"))
        console.print(Panel(Markdown(final_state["trader_investment_plan"]), title="Trader", border_style="blue", padding=(1, 2)))

    # IV. Final Portfolio Decision
    if final_state.get("risk_debate_state"):
        risk = final_state["risk_debate_state"]
        if risk.get("judge_decision"):
